...
| Every individual run | `experiment/exp3/tables/tableS_exp3_trial_records.csv` | 60 rows (3 conditions × 4 tasks × 5 repeats). Per-trial booleans + tokens + tools-called list. |
